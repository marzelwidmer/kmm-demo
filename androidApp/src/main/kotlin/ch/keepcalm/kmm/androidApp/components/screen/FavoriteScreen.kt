    ...
    Column(
        ...
        Row(
            ...
            Card(modifier = Modifier.padding(1.dp), elevation = 16.dp, shape = CircleShape) {
                Image(
                    modifier = Modifier.padding(25.dp), imageVector = Icons.Default.Favorite,
                    contentDescription = "Favorite", colorFilter = ColorFilter.lighting(Color.Blue, add = Color.Red)
                )

            }
            Spacer(modifier = Modifier.padding(5.dp))
            Text(text = "Favorite Screen", style = TextStyle(fontSize = 22.sp, fontStyle = FontStyle.Normal), color = Color.Red)
        }
    }
}